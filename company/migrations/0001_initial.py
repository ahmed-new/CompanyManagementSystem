...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stage', models.CharField(choices=[('Pending', 'Pending Review'), ('Scheduled', 'Review Scheduled'), ('Feedback', 'Feedback Provided'), ('Approval', 'Under Approval'), ('Approved', 'Review Approved'), ('Rejected', 'Review Rejected')], default='Pending', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_employees', models.ManyToManyField(to='company.employee')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='company.company')),
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='company.department')),
            ],
        ),
